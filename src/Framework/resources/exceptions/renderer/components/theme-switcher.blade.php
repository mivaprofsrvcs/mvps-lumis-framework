...
>
    <button
        ...
        @click="menu = ! menu"
    >
        <x-lumis-exceptions-renderer::icons.sun class="block h-5 w-5 dark:hidden" />
        <x-lumis-exceptions-renderer::icons.moon class="hidden h-5 w-5 dark:block" />
    </button>
    ...
    >
        <button
            ...
            @click="lightMode()"
        >
            <x-lumis-exceptions-renderer::icons.sun class="h-5 w-5" />
            Light
        </button>
        <button
            class="flex items-center gap-3 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700"
            ...
            @click="darkMode()"
        >
            <x-lumis-exceptions-renderer::icons.moon class="h-5 w-5" />
            Dark
        </button>
        <button
            class="flex items-center gap-3 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700"
            ...
            @click="systemMode()"
        >
            <x-lumis-exceptions-renderer::icons.computer-desktop class="h-5 w-5" />
            System
        </button>
    </div>
</div>
